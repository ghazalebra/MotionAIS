...
if __name__ == '__main__':
    ...
    path_variants = [
    # 'BG/Contraint/Prise01', 'BG/Contraint/Prise02', 
    'BG/Libre/Prise01', 'BG/Libre/Prise02', 
    # 'BD/Contraint/Prise01', 'BD/Contraint/Prise02', 
    'BD/Libre/Prise01', 'BD/Libre/Prise02', 
    # 'autocorrection/Prise01', 'autocorrection/Prise02'
    ]
